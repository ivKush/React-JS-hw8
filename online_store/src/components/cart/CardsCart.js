...
function CardsCart(props) {

    const [cartCurrent, setCartCurrent] = useState(props.product)
            ...
            <div class="cart-left-specification">
                <div class="cart-left-specification-title">
                    <p>{cartCurrent.productName}
                        <button value={cartCurrent.id} class="cart-left-specification-title-cross" onClick={clearCurrentCart}>
                ...
                <div class="cart-left-specification-parameters">
                    <p>Price: <span class="cartPrice">$ {cartCurrent.price}</span></p>
                    <p>Color: {cartCurrent.color}</p>
                    <p>Size: {cartCurrent.size} </p>
                </div>
