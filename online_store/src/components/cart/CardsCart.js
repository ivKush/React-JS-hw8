...
function CardsCart(props) {
    ...
    props.total(value, props.product);

    const id = props.product.id;

    return (
        <div class="cart-left-cards">
            <img src={props.product.url} alt="img" class="cart-imgBox" />
            <div class="cart-left-specification">
                <div class="cart-left-specification-title">
                    <p>{props.product.productName}
                        <button
                            value={id}
                            onClick={() => props.clearCurrentCart(id)}
                            class="cart-left-specification-title-cross" >
                ...
                <div class="cart-left-specification-parameters">
                    <p>Price: <span class="cartPrice">$ {props.product.price}</span></p>
